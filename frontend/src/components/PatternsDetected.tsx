    ...
    >
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-1 rounded-full bg-cream-100 px-3 py-1.5 text-xs font-medium text-slate-600 transition-colors hover:bg-cream-200"
        >
          ...
          >
            ...
            {hasMoreInsights && (
              <button
                ...
                className="mt-4 inline-flex items-center gap-2 rounded-full bg-cream-100 px-4 py-2 text-xs font-medium text-slate-600 transition-colors hover:bg-cream-200"
              >
      ...
      {isExpanded && visibleCorrelations.length === 0 && patterns.length > 0 && (
        <div className="mt-5 rounded-[22px] bg-cream-50 px-4 py-4 text-sm text-slate-500">
